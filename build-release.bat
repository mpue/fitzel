...
echo Baue sandbox + player + shadercheck + audiocheck + citycheck + iconcheck + fpak ^(Release^)...
"%CMAKE%" --build build\release --target sandbox player shadercheck audiocheck citycheck iconcheck fpak
if %errorlevel% neq 0 (
