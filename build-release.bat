...
echo Baue sandbox + player + shadercheck + audiocheck + citycheck + fpak ^(Release^)...
"%CMAKE%" --build build\release --target sandbox player shadercheck audiocheck citycheck fpak
if %errorlevel% neq 0 (
