...
void addQuad(pathtrace::Scene& sc, const glm::vec3& a, const glm::vec3& b,
...
void addBox(pathtrace::Scene& sc, const glm::vec3& c, const glm::vec3& h, int mat) {
...
pathtrace::CameraDesc lookAt(const glm::vec3& eye, const glm::vec3& target, float fov) {
...
std::shared_ptr<pathtrace::Scene> furnaceScene() {
...
std::shared_ptr<pathtrace::Scene> shadowScene() {
    auto sc = std::make_shared<pathtrace::Scene>();
...
std::shared_ptr<pathtrace::Scene> lookScene() {
    auto sc = std::make_shared<pathtrace::Scene>();
    pathtrace::Material ground;
